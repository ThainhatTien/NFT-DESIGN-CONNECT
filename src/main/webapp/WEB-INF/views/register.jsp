	...
	<main class="">
		<div class="d-flex justify-content-center align-items-center">
			<div class="card_register">
				<div class="form_register border">
					...
					<form:form method="post" modelAttribute="user"
						...
						<form:input type="password" name="password" path="password"
							class="form-control" placeholder="Pass Word" />
						<form:input type="email" name="email" path="email"
							class="form-control" placeholder="Email" />
						<form:input type="text" name="phone" path="phone"
							class="form-control" placeholder="Phone" />
						<form:input type="text" name="facebook" path="facebook"
							class="form-control" placeholder="Face book" />
						<form:input type="file" name="avatar" path="avatar"
							class="form-control" placeholder="Avatar" />
						<form:select name="role" path="role" class="form-control mb-2">
							<form:option value="" label="-- Select Role --" />
							<form:option value="USER" label="User" />
							<form:option value="DESIGN" label="Design" />
						</form:select>
						<form:textarea type="text" name="description" path="description"
